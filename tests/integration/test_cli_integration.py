...
class TestCLIIntegration:
    ...
    def run_cli(self, *args):
        ...
        output"""
        # Note: Ensure the path 'src/cli.py' is correct for your project structure
    ...
    def test_cli_subtract_missing_operand_error(self):
        ...
        # CORRECTED: The CLI now prints a specific "Error:" message for missing operands,
        # instead of a generic "Unexpected error:".
        assert result.stdout.strip().startswith(
            "Error: Operation 'subtract' requires two numbers."
        )
